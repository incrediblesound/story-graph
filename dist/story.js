...
"use strict";
/* harmony export (immutable) */ __webpack_exports__["d"] = twoActors;
/* harmony export (immutable) */ __webpack_exports__["a"] = checkMatch;
/* harmony export (immutable) */ __webpack_exports__["b"] = matchRulesFor;
/* harmony export (immutable) */ __webpack_exports__["c"] = randomMatch;
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__lib_checkTransitionMatch__ = __webpack_require__(7);
...
function matchRulesFor(world, actorOne, actorTwo, action) {
    const matchedRules = [];
...
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__components_constants__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_actor__ = __webpack_require__(2);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__components_story__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_events__ = __webpack_require__(12);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__components_time__ = __webpack_require__(14);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__components_utility__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__components_lib_getLocalRules__ = __webpack_require__(9);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__components_lib_checkTransitionMatch__ = __webpack_require__(7);
...
class World {
    ...
    renderEvent(events) {
        ...
        events.forEach(storyEvent => {
            ...
            if (results) {
                ...
                output += Object(__WEBPACK_IMPORTED_MODULE_3__components_events__["a" /* processEvent */])(this, rule, actorOne, actorTwo);
            }
        });
    ...
    runStory(steps, theEvents = []) {
        ...
        while (this.timeIndex < steps) {
            Object(__WEBPACK_IMPORTED_MODULE_4__components_time__["a" /* advanceTime */])(this);
        }
    }
    ...
    findRule(piece) {
        const source = Object(__WEBPACK_IMPORTED_MODULE_5__components_utility__["b" /* getActor */])(this, piece[0]);
        const action = piece[1];
        const target = Object(__WEBPACK_IMPORTED_MODULE_5__components_utility__["b" /* getActor */])(this, piece[2]);
        if (source && target) {
            for (let i = 0; i < this.numRules; i++) {
                const rule = this.rules[i];
                if (Object(__WEBPACK_IMPORTED_MODULE_2__components_story__["a" /* checkMatch */])(rule, source, target, action)) {
    ...
    populateMatchesForActor(actor, results) {
        ...
        let localRules = Object(__WEBPACK_IMPORTED_MODULE_6__components_lib_getLocalRules__["a" /* default */])(this, actor);
        const transitionRules = this.rules.filter(rule => Object(__WEBPACK_IMPORTED_MODULE_7__components_lib_checkTransitionMatch__["a" /* default */])(rule, actor));
        if (!localActors.length && !results[actor.name]) {
            ...
            localActors.forEach(actorTwo => {
                ...
                localRules.forEach(rule => {
                    const isMatch = Object(__WEBPACK_IMPORTED_MODULE_2__components_story__["a" /* checkMatch */])(rule, actor, actorTwo);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__components_actor__ = __webpack_require__(2);
    ...
    typeExpressionArray.forEach((expr) => {
        switch (expr[1]) {
            ...
            default: {
                ...
                const rules = Object(__WEBPACK_IMPORTED_MODULE_1__story__["b" /* matchRulesFor */])(world, source, target, expr[1]);
